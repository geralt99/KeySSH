...
wget https://raw.githubusercontent.com/geralt99/SSHPlus/master/Modulos/list > /dev/null 2>&1
wget https://raw.githubusercontent.com/geralt99/SSHPlus/master/Modulos/versao -O /bin/versao > /dev/null 2>&1
wget https://raw.githubusercontent.com/geralt99/SSHPlus/master/Modulos/licence -O /usr/lib/licence > /dev/null 2>&1
clear
